            ...
            <main className="flex-1 w-full bg-[#F6FBFB] max-w-360 mx-auto  px-6 py-10 ">
                ...
                <div className="w-full flex flex-col md:flex-row items-start  gap-5 ">
                    ...
                    <div className="md:w-[50%] order-2 md:order-1 mb-6 md:mb-0 flex flex-col justify-between md:min-h-100 ">
                        ...
                        <div className="mb-6">
                            <h1 className="font-fraunces text-4xl text-[#00242F] font-normal leading-10 mb-2">Almost there.</h1>
                            <p className="text-[16px] leading-6 text-[#57666B] mb-4">A few details and you're booked.</p>
                        </div>

                        {/* Dynamic Alert Container pushed to the bottom */}
                        <div className="mt-auto w-full">
                                    ...
                                    <div className="flex flex-col items-start justify-center">
                                        ...
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                <path d="M13.3327 8.66664C13.3327 12 10.9993 13.6666 8.22602 14.6333C8.08079 14.6825 7.92304 14.6802 7.77935 14.6266C4.99935 13.6666 2.66602 12 2.66602 8.66664V3.99997C2.66602 3.63203 2.96474 3.33331 3.33268 3.33331C4.66602 3.33331 6.33268 2.53331 7.49268 1.51997C7.78446 1.27069 8.21423 1.27069 8.50602 1.51997C9.67268 2.53997 11.3327 3.33331 12.666 3.33331C13.034 3.33331 13.3327 3.63203 13.3327 3.99997V8.66664" stroke="#F8FDFD" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M6 8.00008L7.33333 9.33341L10 6.66675" stroke="#F8FDFD" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
                                            Accept new price
                                        </button>
                                    </div>
                            ...
                            {step === 3 && (
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="px-4 py-3.5 rounded-2xl border border-green-200 bg-green-50 flex flex-col gap-1">
                                        ...
                                        <p className="text-sm font-medium text-green-600 ml-6 mt-0.5">
                                    ...
                                    <div className="w-full hidden px-4 py-4 rounded-2xl border border-black/10 bg-white lg:flex flex-col">
                                        ...
                                        <button onClick={() => setStep(4)} className="text-sm text-[#57666B] leading-5 transition-colors text-center">
                            ...
                            {/* ── STEP 4: Accepted green banner ── */}
                            {step === 4 && (
                                <div className="p-14 rounded-2xl border border-[#269E5F]/40 bg-[#269E5F]/5 flex flex-col gap-1">
                                    <div className="flex items-center gap-2">
                                        <p className="text-sm font-normal text-black/50">The price has changed.</p>
                                    </div>
                                    <p className="text-sm text-[#57666B] ml-6">
                                        New price <span className="font-semibold text-navy">€428</span> (was €412). Please confirm to continue.
                                    </p>
                                    <p className="text-sm font-medium text-[#269E5F] ml-6 mt-0.5">
                                        Accepted · Continue below
                                    </p>
                                </div>
                            )}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] md:grid-cols-1   ">
                    ...
                    <div className="md:mt-6">
                        ...
                        {/* Lead Traveler Form */}
                        <div className={`rounded-2xl bg-[#FFFFFF] border border-[#D5E0E2] p-6  transition-opacity ${formDisabled ? "opacity-40" : "opacity-100"}`}>
                        ...
                        {/* Payment Form */}
                        <div className={`bg-white rounded-2xl border border-black/10 p-6 my-6 mt-8 transition-opacity ${formDisabled ? "opacity-40" : "opacity-100"}`}>
                        ...
                        <div>
                            <button
                                ...
                                className="w-full py-2 mb-2 rounded-full text-sm font-medium text-white border border-[#8B6D12] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                style={{ background: "linear-gradient(134deg, rgba(64,118,189,0.50) 35.01%, rgba(30,58,95,0.50) 85.14%), #1E3A5F" }}
                            >
                                Pay €412 &amp; confirm
                            </button>
