        ...
        <footer className="bg-[#FFF] border-t border-black/5 px-6 py-4 text-sm text-gray-500">
            ...
            <div className="lg:hidden">
                <div className="flex items-center justify-between mb-2">
                    <LogoMark />
                    <Link href="/agencies" className="text-sm text-gray-500 hover:text-navy transition-colors">
                        For agencies
                    </Link>
                </div>
...
function LogoMark() {
    return (
        <div className="flex items-center gap-2 text-[18px] text-[#1E3A5F]  font-fraunces font-semibold">
            <div className="w-8 h-8 bg-[#1E3A5F] rounded-[14px] flex items-center justify-center">
            ...
            <h2>Tr<span className="text-[#F6C330] ">AI</span>veller</h2>
        </div>
    );
}